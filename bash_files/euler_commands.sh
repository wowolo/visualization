...
# submit the job
bsub -G ls_math -J $tag -o $log -e $err -n $n_core -W $max_time -N -R "rusage[mem=$memory, ngpus_excl_p=$n_gpus]" "python $project_path/main.py \$LSB_JOBINDEX --experimentbatch_name $tag --config_trainer ${config_trainer[@]}"
