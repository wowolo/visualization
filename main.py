...
if d>1:
  ...
  x_train[:,0]=np.concatenate((np.array(np.linspace(x_min,x_max,np.int(n_samples/2))),np.array(np.linspace(x_min,x_max,np.int(n_samples/2)))))

  x_train[:,1]=np.concatenate((np.sin(1.5*np.pi*np.array(np.linspace(x_min,x_max,np.int(n_samples/2)))),-np.sin(1.5*np.pi*np.array(np.linspace(x_min,x_max,np.int(n_samples/2))))))
