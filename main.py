...
) # <- opportunity to make custom config structure which might
# only be relevant for this type of experiments - general config strucute handled in the respective data, architecture and training objects
manager.run()
